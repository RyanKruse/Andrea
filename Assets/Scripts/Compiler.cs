...
public class Compiler : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _andreaGameObject;
    ...
    private void PopulateStyleSheet()  // Parallel Code.
    {
        ...
        Andrea _andrea = _andreaGameObject.GetComponent<Andrea>();
        _andreaGameObject.GetComponent<Andrea>().PopulateStyleSheet(_styleSheetTextAsset);
        _styleSheetNameList = _andrea._styleSheetNameList;
        _styleSheetTagList = _andrea._styleSheetTagList;
    }
    ...
    private void RotatePageInput()  // Parallel Code.
    {
        ...
        if (Input.GetKeyDown("[0]"))
        {
            ...
            if (_tabletOrientation == "V")
            {
                ...
                _compilerGameObject.transform.Rotate(new Vector3(0f, 0f, 90f));
